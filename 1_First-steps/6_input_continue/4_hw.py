...
# b = int(input())
# Возникнет ошибка!
# Чтобы считать три значения,
# которые поступают через пробел в  одной строке пользуйтесь следующей инструкцией
...
print((lambda x, y, z: x * y * z * 2)(*map(int, input().split())))
